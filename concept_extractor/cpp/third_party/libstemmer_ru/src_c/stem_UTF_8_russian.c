...
#endif
static const symbol s_0_0[10] = {0xD0, 0xB2, 0xD1, 0x88, 0xD0,
                                 0xB8, 0xD1, 0x81, 0xD1, 0x8C};
static const symbol s_0_1[12] = {0xD1, 0x8B, 0xD0, 0xB2, 0xD1, 0x88,
                                 0xD0, 0xB8, 0xD1, 0x81, 0xD1, 0x8C};
static const symbol s_0_2[12] = {0xD0, 0xB8, 0xD0, 0xB2, 0xD1, 0x88,
                                 0xD0, 0xB8, 0xD1, 0x81, 0xD1, 0x8C};
...
static const struct among a_0[9] = {{10, s_0_0, 0, 1, 0},  {12, s_0_1, -1, 2, 0},
                                    {12, s_0_2, -2, 2, 0}, {2, s_0_3, 0, 1, 0},
                                    {4, s_0_4, -1, 2, 0},  {4, s_0_5, -2, 2, 0},
                                    {6, s_0_6, 0, 1, 0},   {8, s_0_7, -1, 2, 0},
                                    {8, s_0_8, -2, 2, 0}};
...
static const struct among a_1[26] = {
    {6, s_1_0, 0, 1, 0},  {6, s_1_1, 0, 1, 0},  {4, s_1_2, 0, 1, 0},
    {4, s_1_3, 0, 1, 0},  {4, s_1_4, 0, 1, 0},  {4, s_1_5, 0, 1, 0},
    {4, s_1_6, 0, 1, 0},  {4, s_1_7, 0, 1, 0},  {4, s_1_8, 0, 1, 0},
    {4, s_1_9, 0, 1, 0},  {4, s_1_10, 0, 1, 0}, {4, s_1_11, 0, 1, 0},
    {4, s_1_12, 0, 1, 0}, {4, s_1_13, 0, 1, 0}, {6, s_1_14, 0, 1, 0},
    {6, s_1_15, 0, 1, 0}, {4, s_1_16, 0, 1, 0}, {4, s_1_17, 0, 1, 0},
    {4, s_1_18, 0, 1, 0}, {4, s_1_19, 0, 1, 0}, {4, s_1_20, 0, 1, 0},
    {4, s_1_21, 0, 1, 0}, {4, s_1_22, 0, 1, 0}, {4, s_1_23, 0, 1, 0},
    {6, s_1_24, 0, 1, 0}, {6, s_1_25, 0, 1, 0}
};
...
static const struct among a_2[8] = {{4, s_2_0, 0, 1, 0},  {6, s_2_1, -1, 2, 0},
                                    {6, s_2_2, -2, 2, 0}, {2, s_2_3, 0, 1, 0},
                                    {4, s_2_4, -1, 1, 0}, {6, s_2_5, -1, 2, 0},
                                    {4, s_2_6, 0, 1, 0},  {4, s_2_7, 0, 1, 0}};

static const symbol s_3_0[4] = {0xD1, 0x81, 0xD1, 0x8C};
static const symbol s_3_1[4] = {0xD1, 0x81, 0xD1, 0x8F};
static const struct among a_3[2] = {{4, s_3_0, 0, 1, 0}, {4, s_3_1, 0, 1, 0}};
...
static const struct among a_4[46] = {
    {4, s_4_0, 0, 2, 0},   {4, s_4_1, 0, 1, 0},   {6, s_4_2, -1, 2, 0},
    {4, s_4_3, 0, 2, 0},   {4, s_4_4, 0, 1, 0},   {6, s_4_5, -1, 2, 0},
    {4, s_4_6, 0, 2, 0},   {4, s_4_7, 0, 1, 0},   {6, s_4_8, -1, 2, 0},
    {4, s_4_9, 0, 1, 0},   {6, s_4_10, -1, 2, 0}, {6, s_4_11, -2, 2, 0},
    {6, s_4_12, 0, 1, 0},  {6, s_4_13, 0, 2, 0},  {2, s_4_14, 0, 2, 0},
    {4, s_4_15, -1, 2, 0}, {4, s_4_16, 0, 1, 0},  {6, s_4_17, -1, 2, 0},
    {6, s_4_18, -2, 2, 0}, {4, s_4_19, 0, 1, 0},  {6, s_4_20, -1, 2, 0},
    {6, s_4_21, 0, 1, 0},  {6, s_4_22, 0, 2, 0},  {6, s_4_23, 0, 1, 0},
    {8, s_4_24, -1, 2, 0}, {8, s_4_25, -2, 2, 0}, {4, s_4_26, 0, 1, 0},
    {6, s_4_27, -1, 2, 0}, {6, s_4_28, -2, 2, 0}, {2, s_4_29, 0, 1, 0},
    {4, s_4_30, -1, 2, 0}, {4, s_4_31, -2, 2, 0}, {2, s_4_32, 0, 1, 0},
    {4, s_4_33, -1, 2, 0}, {4, s_4_34, -2, 2, 0}, {4, s_4_35, 0, 2, 0},
    {4, s_4_36, 0, 1, 0},  {4, s_4_37, 0, 2, 0},  {2, s_4_38, 0, 1, 0},
    {4, s_4_39, -1, 2, 0}, {4, s_4_40, 0, 1, 0},  {6, s_4_41, -1, 2, 0},
    {6, s_4_42, -2, 2, 0}, {4, s_4_43, 0, 1, 0},  {6, s_4_44, -1, 2, 0},
    {6, s_4_45, -2, 1, 0}
};
...
static const struct among a_5[36] = {
    {2, s_5_0, 0, 1, 0},   {4, s_5_1, 0, 1, 0},   {6, s_5_2, -1, 1, 0},
    {4, s_5_3, 0, 1, 0},   {2, s_5_4, 0, 1, 0},   {2, s_5_5, 0, 1, 0},
    {2, s_5_6, 0, 1, 0},   {4, s_5_7, -1, 1, 0},  {4, s_5_8, -2, 1, 0},
    {2, s_5_9, 0, 1, 0},   {4, s_5_10, -1, 1, 0}, {4, s_5_11, -2, 1, 0},
    {2, s_5_12, 0, 1, 0},  {4, s_5_13, 0, 1, 0},  {4, s_5_14, 0, 1, 0},
    {2, s_5_15, 0, 1, 0},  {4, s_5_16, -1, 1, 0}, {4, s_5_17, -2, 1, 0},
    {2, s_5_18, 0, 1, 0},  {4, s_5_19, -1, 1, 0}, {4, s_5_20, -2, 1, 0},
    {6, s_5_21, -3, 1, 0}, {8, s_5_22, -1, 1, 0}, {6, s_5_23, -5, 1, 0},
    {2, s_5_24, 0, 1, 0},  {4, s_5_25, -1, 1, 0}, {6, s_5_26, -1, 1, 0},
    {4, s_5_27, -3, 1, 0}, {4, s_5_28, -4, 1, 0}, {4, s_5_29, 0, 1, 0},
    {6, s_5_30, -1, 1, 0}, {4, s_5_31, 0, 1, 0},  {4, s_5_32, 0, 1, 0},
    {6, s_5_33, -1, 1, 0}, {4, s_5_34, 0, 1, 0},  {2, s_5_35, 0, 1, 0}
};
...
static const struct among a_6[2] = {{6, s_6_0, 0, 1, 0}, {8, s_6_1, 0, 1, 0}};
...
static const struct among a_7[4] =
    {{6, s_7_0, 0, 1, 0}, {2, s_7_1, 0, 3, 0}, {8, s_7_2, 0, 1, 0}, {2, s_7_3, 0, 2, 0}};
